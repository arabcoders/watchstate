...
class IpUtils
{
    ...
    /**
     * Validate if given ip is valid.
     *
     */
    public static function validateIp(string $requestIp): bool
    {
        $flag = substr_count($requestIp, ':') > 1 ? FILTER_FLAG_IPV6 : FILTER_FLAG_IPV4;

        return false !== filter_var($requestIp, FILTER_VALIDATE_IP, $flag);
    }
