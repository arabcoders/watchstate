...
class PlexClient implements iClient
{
    ...
    {
        return Container::get(PlexValidateContext::class)($this->withContext($context)->getContext());
    }
        ...
        try {
            ...
            if (Status::OK !== Status::from($response->getStatusCode())) {
                ...
                throw new RuntimeException(
                    r(
                        text: 'Request for servers list returned HTTP {response.status_code}. {context}',
                        context: [
