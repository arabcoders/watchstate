...
#[Table(name: 'backend_reports')]
final class BackendReport extends BaseModel
{
    #[Transform(ScalarTransformer::class, ScalarType::INT, nullable: true)]
    #[Column(type: ColumnType::Int, primary: true, autoIncrement: true)]
    public ?int $id = null;

    #[Index(name: 'backend_reports_identity')]
    #[Column(type: ColumnType::Text)]
    public string $identity = '';

    #[Index(name: 'backend_reports_status')]
    #[Column(type: ColumnType::Text)]
    public string $status = '';

    #[Index(name: 'backend_reports_generated_at')]
