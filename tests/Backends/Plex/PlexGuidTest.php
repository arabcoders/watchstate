...
class PlexGuidTest extends TestCase
{
    ...
    public function test_has()
    {
        ...
        $this->assertFalse(
            ...
            'Assert that the GUID does not exist.',
        );
    }
    ...
    public function test_parse()
    {
        ...
        $this->assertEquals(
            ...
            'Assert that the GUID does not exist. for invalid GUIDs.',
        );
    }
    ...
    public function test_get()
    {
        ...
        $this->assertEquals(
            ...
            'Assert invalid guid return empty array.',
        );
        ...
        $this->assertEquals(
            [Guid::GUID_IMDB => '1', Guid::GUID_CMDB => 'afa', Guid::GUID_TVDB => '123'],
            $this->getClass()->get([
        ...
        $this->assertEquals(
            [Guid::GUID_TVDB => '84871'],
            $this->getClass()->get([
                ['id' => 'tvdb://84871'],
                ['id' => 'tv.plex.agents.nfo.series://episode/tvdb_84871'],
            ], $context),
            'Assert typed NFO GUIDs do not conflict with identical canonical GUIDs.',
        );
