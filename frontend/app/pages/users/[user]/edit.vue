            ...
            <div class="card-content">
              ...
              <div class="field">
                <label class="label has-text-danger">
                  ...
                  Do not edit the backends name, as indexing and data are keyed by it! This may lead
                  to data loss.
                </label>
                <div class="control">
                  <textarea
            ...
            <footer class="card-footer">
              ...
              <span class="card-footer-item">
                <NuxtLink
                  ...
                  :to="(useRoute().query.redirect as string) || '/users'"
                >
        ...
        <Message message_class="is-info" :newStyle="true">
          <ul>
            ...
            <li class="has-text-danger">
              ...
              <span
                >Directly editing the config must only be done as last resort. Making mistakes may
                break the user's backend configurations, or lead to data loss.</span
              >
            </li>
            <li>
              If you edit the backend name, you will have to force database reindex to re-generate
              the indexes. And you will have stale data. Best avoid changing backend names. If you
              must, than delete the user db file in order to re-generate data.
            </li>
          </ul>
        </Message>
      </div>
