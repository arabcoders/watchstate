    ...
    <div class="columns is-multiline">
      <div class="column is-12 is-clearfix is-unselectable">
          ...
          <div class="field is-grouped">
            ...
            <p class="control">
              <button
                ...
                @click="massDelete"
                v-tooltip.bottom="'Delete selected records.'"
        ...
        <div class="is-hidden-mobile">
          <span class="subtitle"
            >This page will show records with files that no longer exist on the system.</span
          >
        </div>
      </div>
      ...
      <div class="column is-12" v-if="isLoaded">
        ...
        <Message
          ...
          v-if="filter && filteredRows(items).length < 1"
          title="Information"
          icon="fas fa-check"
        >
        ...
        <Message
          ...
          v-else-if="!isLoading && items.length < 1"
          title="Success"
          icon="fas fa-check"
        >
          ...
          <div class="card-content">
            <div class="content">
              <ul>
                ...
                <li>
                  This check <strong><code>REQUIRES</code></strong> that the file contents be
                  accessible to <code>WatchState</code>. You should mount your library in
                  <code>compose.yml</code> file as readonly.
                  <span class="is-bold"
                    >If you do not mount your library. every record will fail the check.</span
                  >
                </li>
                <li>
                  There are no path replacement support at the moment. The path must match what your
                  media servers are reporting. There are plans to add this feature in the future.
                </li>
                <li>
                  This process will do two checks, One will do dir stat on the file directory, and
                  file stat on the file itself if the directory exists.
                  <span class="has-text-danger"
                    >If you are using cloud storage, we recommend to not use this check. as it will
                    be slow. and probably will cost you a lot of money.</span
                  >
                </li>
                <li>
                  The process caches the file and dir stat, as such we only run stat once per file
                  or directory no matter how many backends reports the same path or file.
                </li>
                      ...
                      <div class="field is-grouped">
                        ...
                        <div class="control">
                          <NuxtLink
                            ...
                            v-tooltip.bottom="
                              !record.status ? record.backend + ': ' + record.message : ''
                            "
                          >
                            <span class="icon">
                              <i
                                class="fas"
                                :class="{ 'fa-xmark': !record.status, 'fa-check': record.status }"
                              />
                            </span>
