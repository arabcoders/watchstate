  ...
  <div>
    <div class="columns is-multiline">
      ...
      <div class="column is-12" v-if="isLimitedToken">
        ...
        >
          <p>
            This backend is using accesstoken instead of API keys, And this method untested and may
            not work as expected. Please make sure you know what you are doing. Simple operations
            like <strong>Import</strong>, <strong>Export</strong> should work fine.
          </p>
          <p>
            How the access token interact with the rest of the API is undefined and untested by us.
            Please use with caution. If you notice any issue, please report it to us.
          </p>
        </Message>
      </div>
          ...
          <div class="card">
            <header class="card-header">
              <p class="card-header-title">
                Edit Backend:&nbsp;<u class="has-text-danger">{{ api_user }}</u
                >@{{ backend.name }}
              </p>
            </header>
            ...
            <div class="card-content">
              <div class="field">
                ...
                <p class="help is-unselectable">
                  The local user which this backend is associated with.
                </p>
              </div>
                  ...
                  <div class="field">
                    <div class="field has-addons">
                      ...
                      <div class="control">
                        ...
                        >
                          <span class="icon"
                            ><i class="fas" :class="exposeToken ? 'fa-eye-slash' : 'fa-eye'"
                          /></span>
                        </button>
                      </div>
                    </div>
              ...
              <div class="field">
                      ...
                      >
                        <span class="icon"
                          ><i
                            class="fa"
                            :class="{
                              'fa-spinner fa-spin': uuidLoading,
                              'fa-refresh': !uuidLoading,
                            }"
                        /></span>
                        <span class="is-hidden-mobile">Reload</span>
                      </button>
                ...
                <p class="help">
                  <span v-if="'plex' === backend.type">
                    The backend unique ID is random string generated on server setup, In Plex case
                    it used to inquiry about the users associated with the server to generate
                    limited <strong>X-Plex-Token</strong> for them. It used by webhooks as a filter
                    to match the backend. in-case you are member of multiple servers.
                  </span>
                  <span v-else>
                    The backend unique ID is a random string generated on server setup. It is used
                    to identify the backend uniquely. This is used for webhook matching and
                    filtering.
                  </span>
                </p>
              </div>
              ...
              <div class="field">
                ...
                <p class="help">
                  <span v-if="'plex' === backend.type">
                    Plex doesn't use standard API practice for identifying users. They use
                    <strong>X-Plex-Token</strong>
                  ...
                  <span v-else>
                    Which user should this backend configuration use? The User will determine the
              ...
              <div class="field">
                ...
                <p class="help is-unselectable">
                  These are advanced options. Please only change them, if you are told to do so by
                  the developers.
                </p>
                    ...
                    <template v-for="_option in flatOptionPaths" :key="'bo-' + _option">
                        ...
                        <p class="help is-unselectable">
                          <span class="icon has-text-info">
                            <i
                              ...
                              :class="{ 'fa-bounce': newOptions[_option] }"
                            />
                          </span>
                      ...
                      <div class="column is-6">
                        <input
                          type="text"
                          class="input"
                          :value="option_get(_option)"
                          @input="
                            (e: Event) =>
                              option_set(_option, (e.target as HTMLInputElement)?.value || '')
                          "
                          required
                        />
                      </div>
                      <div class="column is-1">
                        <button
                          ...
                          @click.prevent="removeOption(_option)"
                        >
                    ...
                    <div class="column is-5">
                      <div class="select is-fullwidth">
                        <select v-model="selectedOption">
                          ...
                          <option
                            v-for="option in filteredOptions(optionsList)"
                            :key="'opt-' + option.key"
                            :value="option.key"
                          >
                            {{ option.key }}
            ...
            <div class="card-footer">
              ...
              <NuxtLink
                class="card-footer-item button is-fullwidth is-danger"
                :to="`/backend/${id}`"
              >
...
const loadContent = async (): Promise<void> => {
  ...
  if ('error' in supportedData) {
    notification(
      'error',
      'Error',
      `Failed to load supported backends: ${supportedData.error.message}`,
    );
    return;
  }
