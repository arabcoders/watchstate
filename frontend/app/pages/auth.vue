            ...
            <div class="column is-6-tablet is-6-desktop is-4-widescreen">
              ...
              <div class="box" v-if="forgot_password">
                <div class="content">
                  <h4>
                    <span class="icon"
                      ><i class="fa fa-lock" :class="{ 'fa-fade': polling_timer }"
                    /></span>
                    <span>How to Reset system login</span>
                  </h4>
                  <p>
                    To reset your system password, you need to run the following command from your
                    docker host
                  </p>
                  ...
                  <div class="has-text-danger">
                    <ul>
                      <li>
                        Once you have run the command, return to this page and to create a new user
                        account.
                      </li>
                      <li>
                        You can also reset the password by removing the <code>.env</code> file found
                ...
                <div class="field is-grouped">
                  <div class="control is-expanded">
                    <button
                      class="button is-fullwidth is-info is-dark"
