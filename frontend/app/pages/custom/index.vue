              ...
              <div class="card">
                <header class="card-header">
                  <template v-if="link.replace?.from">
                    <p
                      class="card-header-title is-text-overflow pr-1 is-unselectable is-clickable"
                    ...
                    >
                      <span class="icon"
                        ><i
                          class="fas"
                          :class="{
                            'fa-arrow-down': false === (link.show ?? false),
                            'fa-arrow-up': true === (link.show ?? false),
                          }"
                        ></i
                        >&nbsp;</span
                      >
        ...
        >
          <ul>
            <li>
              ...
              databases, so this feature instead allow you to manually do it yourself.
            </li>
            <li>
              Adding Custom guid without a client/s links is useless as the parsing engine will not
              know what to do with it. So, make sure to add a client GUID link referencing the
              custom GUID.
            </li>
            ...
            <li>
              ...
              unexpected behavior. Please use the WebUI to manage the GUIDs. as we expose the entire
              functionality via the WebUI. with safeguards to prevent you from doing something that
            ...
            <li>
              ...
              command to rebuild the database indexes. While not required, it is recommended to
              ensure the database is up to date. and the indexing is correct and for speedy database
              operations.
            </li>
            <li>
              The links are global for each client, not the backend itself. So, For example, if you
              have NN jellyfin backends and you add new GUID link for jellyfin, it will be applied
              to all jellyfin backends. The backends themselves don't need to report it, however the
              support will be available for all backends.
            </li>
            <li>
              For more information please read the content in the <code>FAQ.md</code> page, or
              directly via
              <NuxtLink
                target="_blank"
