  ...
  <div>
    <div class="columns is-multiline">
      ...
      <div class="column is-12" v-if="error">
        <Message
          message_class="is-background-danger-80 has-text-dark"
          title="Error"
      ...
      <template v-if="isPurging">
        <div class="column is-12">
          <Message
            ...
            message="Cache purging in progress, Please wait..."
          />
        </div>
      </template>
      <template v-else>
        ...
        <div class="column is-12">
          <Confirm
            @confirmed="resetCache()"
            :title="`Perform purge cache for all users?`"
            title-icon="fa-trash"
