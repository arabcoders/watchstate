<template>
  <div class="columns is-multiline mb-2">
    ...
    <div class="column is-6 is-12-mobile">
      <div class="card">
        <header class="card-header">
          <p class="card-header-title">WebUI Look & Feel</p>
          <span class="card-header-icon">
        ...
        <div class="card-content">
          ...
          <div class="field">
            <label class="is-unselectable label"> Show posters </label>
            <div class="control">
              <input
                id="show_posters"
                type="checkbox"
                class="switch is-success"
                v-model="poster_enable"
              />
          ...
          <div class="field">
            <label class="label is-unselectable" for="random_bg_opacity">
              Background Visibility: (<code>{{
                (1.0 - parseFloat(String(bg_opacity))).toFixed(2)
              }}</code
              >)
            </label>
            <div class="control">
