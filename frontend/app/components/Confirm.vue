    ...
    <div class="card">
      <header class="card-header">
        ...
        <p class="card-header-icon">
          <span class="icon"><i class="fas" :class="props.titleIcon"></i></span>
        </p>
      </header>
      <div class="card-content">
        <div class="field">
          <label class="label"> To proceed, Enable the switch below to unlock the action. </label>
          <div class="control">
            <input
              id="user_confirm"
              type="checkbox"
              class="switch is-success"
              v-model="user_confirmed"
            />
      ...
      <footer class="card-footer">
        <div class="card-footer-item">
          <button
            ...
            type="submit"
            :disabled="!user_confirmed"
            :class="!user_confirmed ? 'is-primary' : 'is-danger'"
          >
            <span class="icon">
              <i
                class="fas"
                :class="!user_confirmed ? props.lockedButtonIcon : props.unlockedButtonIcon"
              ></i>
            </span>
            <span>
