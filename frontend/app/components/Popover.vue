...
const contentClasses = computed(() => ['popover-content-inner', props.contentClass]);
...
const calculatePosition = () => {
  ...
  if (
    ['top', 'top-start', 'top-end', 'bottom', 'bottom-start', 'bottom-end'].includes(placementToUse)
  ) {
